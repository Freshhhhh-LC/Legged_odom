...
if __name__ == "__main__":
    input_file_path = "/home/luochangsheng/odom/Legged_odom/data/14/1744117702143/rl_locomotion_run_edited.csv"
    output_dir = "/home/luochangsheng/odom/Legged_odom/processed_data/"
    remove_same_rows(input_file_path, output_dir)
    
    booster_file_path = "/home/luochangsheng/odom/Legged_odom/data/14/segments/booster_seg_447.41s.csv"
    mocap_file_path = "/home/luochangsheng/odom/Legged_odom/processed_data/rl_locomotion_run_edited.csv"
    output_file_path = "/home/luochangsheng/odom/Legged_odom/processed_data/merged_output.csv"
    
    merge_files(booster_file_path, mocap_file_path, output_file_path)
